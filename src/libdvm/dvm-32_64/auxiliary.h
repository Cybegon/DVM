...
#define DVM_GET_OPCODE4(i)  ( (i & 0x0F000000u) >> 24u )    // 4    bit
...
#define DVM_GET_R3(i)       ( (i & 0x0000003Eu) >> 1u )     // 5    bit
...
#   define JUMP8() IP = CP + DVM_GET_IMM8(instruction)
#endif
